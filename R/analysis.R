...
meas_t__min = ts_lag(timser_in$(1:0), 1) - timser_in$(1:0)

#water/air partitioning coefficient Kw/air; calculations according to Schubert et al., 2012
temp_wat__K = timser_in$temp_wat__C + 273.15

kw/air=
  exp(-76.14+120.36*(100/temp_wat__K)+31.26*log(temp_wat__K/100)+timser_in$sal_wat)*
  (-0.2631+0.1673*(temp_wat__K/100)+(-0.0273*(temp_wat__K/100)^2)))*temp_wat__K/273.15
