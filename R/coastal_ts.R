...
dat_tbl <- in_tbl %>%
  mutate(
    ...
    # calculation of coastal radon measurement time interval in minutes based on provided measurement times, 
    ...
    # water/air partitioning coefficient kw_air calculation based on water temperature and salinity; 
    # calculations and coefficients adapted from Schubert et al. 2012
    kw_air =
    ...
    # excess Rn in water is calculated by subtracting dissolved 226Ra in water from Rn in water
    ...
    # Rn brought in by tides from offshore - only applicable when water levels are increasing
    ...
    # Rn lost from coastal to offshore areas - only applicable when water levels are decreasing
    ...
    # all derived Rn fluxes summed together to get net Rn flux change per hour
    ...
    # this is a conservative approach providing minimal estimates of mixing loss
